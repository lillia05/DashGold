...
$profitBersih = $totalProfit - ($totalPrive + $totalcicilan + $totalPiutang);
...
$totalAsetBersih = ($modalManual + $modalInternal + $totalAsetStok) - ($modalEksternal + $totalcicilan + $totalPiutang);
